...
RACER_ROOT = Path("/workspace/racer")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default="/workspace/racer/results/megatron_csd_restart")
...
def build_train_cmd(
    *,
    ...
    return [
        ...
        "torch",
        "--data-path",
        "/workspace/data/my_shakespeare_text_document",
        "--vocab-file",
        "/workspace/gpt2_vocab/vocab.json",
        "--merge-file",
        "/workspace/gpt2_vocab/merges.txt",
        "--split",
        "949,50,1",
        "--save",
        str(checkpoint_dir),
